...
describe("getStatusBarHeight", () => {
  describe("iOS", () => {
    ...
    test("Should return 59 when device is iOS and have iPhone 14 Max width and height", () => {
    ...
    test("Should return 59 when device is iOS and have iPhone 14 Pro Max width and height", () => {
